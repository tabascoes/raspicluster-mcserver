...
# 一番最初に実行する場合は、以下を入力してください
# ——————————
# 連番を入力します
# マスター以外の子分に001、002、003と振り分けます
# このラズパイが1つ目なら、001としてください
# この値は毎回変わります
$num = 001
...
# 192.168.0.1の場合、連番01の時192.168.0.101が固定されるipアドレスになります
$ipbase = 192.168.0.1
...
# 2回目の場合は、1回目に出力されたオプションを""の中に入力してください
$option = ""
